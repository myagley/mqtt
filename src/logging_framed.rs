#[derive(Debug)]
pub(crate) struct LoggingFramed<T>(tokio::codec::Framed<T, crate::proto::PacketCodec>) where T: tokio::io::AsyncRead + tokio::io::AsyncWrite;
...
impl<T> futures::Sink for LoggingFramed<T> where T: tokio::io::AsyncRead + tokio::io::AsyncWrite {
	type SinkItem = <tokio::codec::Framed<T, crate::proto::PacketCodec> as futures::Sink>::SinkItem;
	type SinkError = <tokio::codec::Framed<T, crate::proto::PacketCodec> as futures::Sink>::SinkError;
...
impl<T> futures::Stream for LoggingFramed<T> where T: tokio::io::AsyncRead + tokio::io::AsyncWrite {
